				...
				<div class="box maxheight">
					<div class="inner">
						...
						<div class="txt1">
							...
							<ul class="img-list">
								<li><img alt="" src="resources/images/2page-img7.jpg" />Premium food (either at our restaraunt or delivered to your room)</li>
								<li><img alt="" src="resources/images/2page-img8.jpg" />Drinks and bevarages in your rooms</li>
								<li><img alt="" src="resources/images/2page-img9.jpg" />Daily cleaning (included into your package)</li>
								<li><img alt="" src="resources/images/2page-img10.jpg" />Free access to our gym and swimming pool</li>
							</ul>
						</div>
					</div>
				</div>
